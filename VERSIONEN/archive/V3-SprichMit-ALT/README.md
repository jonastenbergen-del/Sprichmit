...
| `VERSIONEN/` | Komplette Backups jeder Version |

## 📦 Versionen

### V1.1 – 11.09.2026 (UI-Feinschliff) 🎨
*(Gleiches Paket wie LernMeister V1.1 – portiert auf diese App)*
- **Gradient-Design**: Indigo→Violett-Verlauf in Topbar + primären Buttons
- **Feedback-Animationen**: ❌ falsche Antwort → Shake, ✅ richtig → grüner Pulse
  (auch beim Wörter-Schreiben: Input wackelt bei Fehler)
- **🎯 „Bir sonraki hedef"-Box** auf der Startseite: zeigt das nächste Wochen-Ziel
  mit Fortschrittsbalken (18 → 36 → 50 Wörter)
- **Toast-Benachrichtigungen**: grün bei Erfolgen (neue Wörter gelernt, perfekter Durchlauf ≥ 80 %)
- **Ansichts-Animationen**: sanfte Einblendung beim Tab-Wechsel
- **Barrierefreiheit**: Focus-Ringe (Tastatur), `prefers-reduced-motion`, ARIA-Labels
- Kein Datenformat-Wechsel – Supabase-Fortschritt bleibt 100 % erhalten

### V1.0 – 08.09.2026 (Erstversion) 🎉
- Grundapp: Login, 6 Tabs, Leitner, Streak, Schreib- & Telefon-Übung, Dashboard
- Backup: `VERSIONEN/V1.0/`